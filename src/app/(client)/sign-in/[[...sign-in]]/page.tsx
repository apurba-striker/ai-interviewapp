    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
          ...
          <div className="absolute bottom-20 right-20 w-40 h-40 bg-purple-500/30 rounded-full blur-xl animate-pulse animation-delay-2000"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          >
            ...
            >
              Transform your interview process with AI-powered insights. Get real-time analytics and intelligent feedback to make better hiring decisions.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">AI-Powered Interview Analysis</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">Advanced Candidate Scoring</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8">
            <div className="text-center mb-8">
              <motion.div
                ...
                className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl mb-4"
              >
      ...
      <div className="lg:hidden fixed inset-0 bg-white z-50 flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            Welcome to Folo<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-600">Up</span>
        </h1>
          <p className="text-gray-600 mb-6">
            Mobile version is coming soon! Please sign in using a desktop for the best experience.
          </p>
